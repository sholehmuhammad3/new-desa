...
<!--								<a href="--><?//=site_url() ?><!--"><img src="--><?//=gambar_desa($header['logo']) ?><!--" alt="--><?//=$header['nama_desa']?><!--" class="img-responsive" /></a>-->
								<div class="login-footer-top">
                                    <h2>Login Page</h2>
                                    <h3><?=ucwords($this->setting->sebutan_desa)?> <?=$header['nama_desa']?></h3>
									<!--h3>
...
<!--									--><?php //else: ?>
										<div class="form-group">
											<input name="username" type="text" placeholder="Nama pengguna" value="" class="form-username form-control required">
										</div>
										<div class="form-group">
											<input name="password" id="password" type="password" placeholder="Kata sandi" value="" class="form-username form-control required">
										</div>
										<div class="form-group">
