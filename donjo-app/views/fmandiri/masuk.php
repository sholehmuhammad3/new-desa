...
<head>
	...
	<?php if ($latar_login_mandiri) : ?>
		<style type="text/css">
			body.login {
				/*background: url('*/<?php //= base_url($latar_login_mandiri) ?>/*');*/
			}
		</style>
	<?php endif; ?>
...
<!--								<a href="https://github.com/OpenSID/OpenSID" class="content-color-secondary" rel="noopener noreferrer" target="_blank">OpenSID --><?php //= AmbilVersi() ?><!--</a>-->
							</div>
						</div>
					</div>
				</div>
