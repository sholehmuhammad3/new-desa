...
<section x-data="{catMenu: false}" class="text-black">
  <button 
    type="button"
  ...
  <div
    ...
    <div class="flex lg:flex-row flex-col justify-between items-center relative z-10">
      <ul class="w-full text-sm text-black">
      ...
      <div class="flex flex-col lg:flex-row gap-3 mt-5 lg:mt-0 flex-wrap lg:justify-end w-full px-3">
        ...
        <?php endif ?>
<!--        <a href="--><?php //= site_url('siteman') ?><!--" class="btn btn-accent text-sm w-full lg:w-auto text-center">Login Admin <i class="fas fa-external-link-alt ml-1"></i></a>-->
      </div>
    </div>
  </div>
