...
<div class="flex justify-between items-center space-x-1 py-5">
  ...
  <div class="text-right space-x-2 text-sm space-y-2 md:space-y-0">
    <button class="btn btn-primary button-switch is-active" data-type="column">Bar Graph</button>
    <button class="btn btn-primary button-switch" data-type="pie">Pie Graph</button>
  </div>
</div>
